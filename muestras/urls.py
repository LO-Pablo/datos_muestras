...
urlpatterns = [
    ...
    path('muestras/upload_excel/descargar', views.descargar_plantilla_muestras, name='descargar_plantilla_muestras'),
    ...
    path('archivo/nuevo/descargar', views.descargar_plantilla_localizaciones, name='descargar_plantilla_localizaciones'),
