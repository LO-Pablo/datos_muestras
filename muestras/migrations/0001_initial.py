    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('muestra', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='localizacion', to='muestras.muestra')),
            ],
        ),
        migrations.CreateModel(
            name='Estudio',
            fields=[
                ...
                ('muestra', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='estudio', to='muestras.muestra')),
            ],
        ),
        migrations.CreateModel(
            name='Envio',
