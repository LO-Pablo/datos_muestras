    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('muestra', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='localizacion', to='muestras.muestra')),
            ],
        ),
        migrations.CreateModel(
            name='Estudio',
            fields=[
                ...
                ('id_individuo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='id_inidividuo_estudio', to='muestras.muestra', to_field='id_individuo')),
                ('nom_lab', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='nom_lab_estudio', to='muestras.muestra', to_field='nom_lab')),
            ],
        ),
        migrations.CreateModel(
            name='Envio',
            fields=[
                ...
                ('id_individuo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='id_inidividuo_envio', to='muestras.muestra', to_field='id_individuo')),
                ('nom_lab', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='nom_lab_envio', to='muestras.muestra', to_field='nom_lab')),
            ],
        ),
    ]
