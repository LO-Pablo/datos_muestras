...
+ Opción para subir un archivo de excel con las muestras, con mensajes de error. Se incluye en la web la plantilla a completar
+ Opción para generar un archivo pdf y/o un excel de las muestras filtradas. 
+ CR de posiciones del archivo de muestras y archivado de muestras individuales con condiciones. 
